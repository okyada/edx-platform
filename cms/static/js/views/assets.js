define(["jquery", "underscore", "gettext", "js/models/asset", "js/views/paging", "js/views/asset",
    "js/views/feedback_prompt", "js/views/feedback_notification", "js/views/paging_header", "js/views/paging_footer",
    "js/utils/modal", "jquery.fileupload"],
    function($, _, gettext, AssetModel, PagingView, AssetView, PromptView, NotificationView, PagingHeader,
             PagingFooter, ModalUtils) {
